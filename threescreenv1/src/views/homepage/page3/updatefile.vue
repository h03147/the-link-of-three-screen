    ...
    <div>
        ...
        <div class="pageinputmaindiv1">
            <el-form :model="insertNewFiletableData" ref="insertNewFiletableData" class="demo-form-inline">
                <el-form-item label="二级菜单:" label-width="4.5vw" prop="secondmenu">
                    <el-row>{{insertNewFiletableData.secondmenu}}</el-row>
                </el-form-item>
                ...
                <el-form-item label="左屏文字:" label-width="4.5vw" prop="leftscreencontext">
                    <el-input class="inputleftcontext1" :rows="5" type="textarea" show-word-limit maxlength="50" size="small" v-model="insertNewFiletableData.leftscreencontext" placeholder="请输入左屏文字"></el-input>
                </el-form-item>

                <el-form-item label="右屏网址:" prop="rightscreenurl" label-width="4.5vw">
                    <el-input class="inputrightcontext1" show-word-limit maxlength="269" type="textarea" size="small" v-model="insertNewFiletableData.rightscreenurl" placeholder="请输入右屏网址"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            const _this = this;
            console.log("leftscreenvideo:" + this.$route.query.leftscreenvideo);
            this.fileListimg1[0].name = this.$route.query.leftscreenminiimg;
            this.fileListvideo1[0].name = this.$route.query.leftscreenvideo;
            ...
            axios.get(api123.baseURL + '/btn3file/filefindById/' + this.$route.query.id).then(function (resp) {
        ...
        methods: {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        const _this = this;
                        axios.put(api123.baseURL + '/btn3file/updatefileById', this.insertNewFiletableData).then(function (resp) {
            ...
            beforeAvatarUploadvideo(file) {
                ...
                if (!isLt100M) {
                    this.$message.error('上传的视频大小不能超过 100MB!');
                }
